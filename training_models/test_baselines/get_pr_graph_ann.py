...
precision_ann, recall_ann, _ = metrics.precision_recall_curve(all_labels, preds_ann)

# Plot the precision-recall curve
plt.plot(recall_ann, precision_ann, color='blue')

plt.title('Precision-Recall Curve for ANN', fontsize=16)
